...
CREATE TABLE `locacao` (
  ...
  `d_evento` varchar(15) NOT NULL,
  `horario_inicio` varchar(45) NOT NULL,
  `horario_fim` varchar(45) NOT NULL,
  `tipo_evento` varchar(60) NOT NULL,
  `qtd_convidados` int(11) NOT NULL,
  `valor_locacao` int(11) NOT NULL,
  `status_loc` varchar(45) NOT NULL,
...
-- Dump completed on 2026-06-11 16:13:01
